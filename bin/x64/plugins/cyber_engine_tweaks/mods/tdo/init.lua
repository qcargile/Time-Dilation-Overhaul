...
local function createApogeeMechanic(nativeSettings, path, nuiTxt, config, default)
	...
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["stillSurvivalSec"]["opt"]..nuiTxt[cat]["stillSurvivalSec"]["optUnit"], nuiTxt[cat]["stillSurvivalSec"]["des"], 5.0, 60.0, 1.0, "%.0f", config.apogee.stillSurvivalSec, default.apogee.stillSurvivalSec, function(value) config.apogee.stillSurvivalSec = value saveSettings(config) end))
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["lookSurvivalSec"]["opt"]..nuiTxt[cat]["lookSurvivalSec"]["optUnit"], nuiTxt[cat]["lookSurvivalSec"]["des"], 5.0, 60.0, 1.0, "%.0f", config.apogee.lookSurvivalSec, default.apogee.lookSurvivalSec, function(value) config.apogee.lookSurvivalSec = value saveSettings(config) end))
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["aimSurvivalSec"]["opt"]..nuiTxt[cat]["aimSurvivalSec"]["optUnit"], nuiTxt[cat]["aimSurvivalSec"]["des"], 5.0, 60.0, 1.0, "%.0f", config.apogee.aimSurvivalSec, default.apogee.aimSurvivalSec, function(value) config.apogee.aimSurvivalSec = value saveSettings(config) end))
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["actionSurvivalSec"]["opt"]..nuiTxt[cat]["actionSurvivalSec"]["optUnit"], nuiTxt[cat]["actionSurvivalSec"]["des"], 5.0, 60.0, 1.0, "%.0f", config.apogee.actionSurvivalSec, default.apogee.actionSurvivalSec, function(value) config.apogee.actionSurvivalSec = value saveSettings(config) end))
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["reflexSurvivalPerPoint"]["opt"]..nuiTxt[cat]["reflexSurvivalPerPoint"]["optUnit"], nuiTxt[cat]["reflexSurvivalPerPoint"]["des"], 0.0, 1.0, 0.05, "%.2f", config.apogee.reflexSurvivalPerPoint, default.apogee.reflexSurvivalPerPoint, function(value) config.apogee.reflexSurvivalPerPoint = value saveSettings(config) end))
	table.insert(handles, nativeSettings.addRangeFloat(path, nuiTxt[cat]["reflexSurvivalCap"]["opt"]..nuiTxt[cat]["reflexSurvivalCap"]["optUnit"], nuiTxt[cat]["reflexSurvivalCap"]["des"], 0.0, 20.0, 0.5, "%.1f", config.apogee.reflexSurvivalCap, default.apogee.reflexSurvivalCap, function(value) config.apogee.reflexSurvivalCap = value saveSettings(config) end))
...
registerForEvent("onInit", function()
	...
	if nativeSettings ~= nil then
		...
		Override("TDOConfig", "ApogeeStillSurvivalSec;", function() return config.apogee.stillSurvivalSec end)
		Override("TDOConfig", "ApogeeLookSurvivalSec;", function() return config.apogee.lookSurvivalSec end)
		Override("TDOConfig", "ApogeeAimSurvivalSec;", function() return config.apogee.aimSurvivalSec end)
		Override("TDOConfig", "ApogeeActionSurvivalSec;", function() return config.apogee.actionSurvivalSec end)
		Override("TDOConfig", "ApogeeReflexSurvivalPerPoint;", function() return config.apogee.reflexSurvivalPerPoint end)
		Override("TDOConfig", "ApogeeReflexSurvivalCap;", function() return config.apogee.reflexSurvivalCap end)
