return {
	...
	{ version = 9.1, resetKeys = {"bulletTrail"} },
	{ version = 10.0, resetKeys = {
		"zetatech.slowTimeMinPct", "zetatech.slowTimeMaxPct",
		"zetatech.durationMin", "zetatech.durationMax",
		"zetatech.rechargeMin", "zetatech.rechargeMax",
		"zetatechShow", "tantoShow", "warpDancerShow", "falconShow", "apogeeShow",
	} },
	{ version = 10.1, resetKeys = {
		"tanto.slowTimeMinPct", "tanto.slowTimeMaxPct",
		"tanto.durationMin", "tanto.durationMax",
		"tanto.rechargeMin", "tanto.rechargeMax",
		"tanto.critChanceMin", "tanto.critChanceMax",
		"tanto.critDmgMin", "tanto.critDmgMax",
	} },
	{ version = 10.2, resetKeys = {
		"warpDancer.slowTimeMinPct", "warpDancer.slowTimeMaxPct",
		"warpDancer.durationMin", "warpDancer.durationMax",
		"warpDancer.rechargeMin", "warpDancer.rechargeMax",
		"falcon.slowTimeMinPct", "falcon.slowTimeMaxPct",
		"falcon.durationMin", "falcon.durationMax",
		"falcon.rechargeMin", "falcon.rechargeMax",
		"falcon.critChanceMin", "falcon.critChanceMax",
		"falcon.critDmgMin", "falcon.critDmgMax",
		"apogee.slowTimeMinPct", "apogee.slowTimeMaxPct",
		"apogee.durationMin", "apogee.durationMax",
		"apogee.rechargeMin", "apogee.rechargeMax",
		"quantum.playerSlowTimePct", "quantum.malwareSlowTimePct",
	} },
	{ version = 10.3, resetKeys = {} },
